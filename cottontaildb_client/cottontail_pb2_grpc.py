...
class DDLStub(object):
    ...
    def __init__(self, channel):
        ...
        self.IndexDetails = channel.unary_unary(
                ...
                request_serializer=cottontail__pb2.IndexDetailsMessage.SerializeToString,
                response_deserializer=cottontail__pb2.QueryResponseMessage.FromString,
                )
        ...
        self.AnalyzeEntity = channel.unary_unary(
                ...
                request_serializer=cottontail__pb2.AnalyzeEntityMessage.SerializeToString,
                response_deserializer=cottontail__pb2.QueryResponseMessage.FromString,
                )
...
def add_DDLServicer_to_server(servicer, server):
    rpc_method_handlers = {
            ...
            'IndexDetails': grpc.unary_unary_rpc_method_handler(
                    ...
                    request_deserializer=cottontail__pb2.IndexDetailsMessage.FromString,
                    response_serializer=cottontail__pb2.QueryResponseMessage.SerializeToString,
            ),
            ...
            'AnalyzeEntity': grpc.unary_unary_rpc_method_handler(
                    ...
                    request_deserializer=cottontail__pb2.AnalyzeEntityMessage.FromString,
                    response_serializer=cottontail__pb2.QueryResponseMessage.SerializeToString,
            ),
...
class DDL(object):
    ...
    def IndexDetails(request,
        ...
        return grpc.experimental.unary_unary(request, target, '/org.vitrivr.cottontail.grpc.DDL/IndexDetails',
            cottontail__pb2.IndexDetailsMessage.SerializeToString,
            cottontail__pb2.QueryResponseMessage.FromString,
            options, channel_credentials,
            insecure, call_credentials, compression, wait_for_ready, timeout, metadata)
    ...
    def AnalyzeEntity(request,
        ...
        return grpc.experimental.unary_unary(request, target, '/org.vitrivr.cottontail.grpc.DDL/AnalyzeEntity',
            cottontail__pb2.AnalyzeEntityMessage.SerializeToString,
            cottontail__pb2.QueryResponseMessage.FromString,
            options, channel_credentials,
            insecure, call_credentials, compression, wait_for_ready, timeout, metadata)
...
class TXNStub(object):
    ...
    def __init__(self, channel):
        ...
        self.Begin = channel.unary_unary(
                ...
                request_serializer=cottontail__pb2.BeginTransaction.SerializeToString,
                response_deserializer=cottontail__pb2.ResponseMetadata.FromString,
                )
        self.Commit = channel.unary_unary(
                '/org.vitrivr.cottontail.grpc.TXN/Commit',
                request_serializer=cottontail__pb2.RequestMetadata.SerializeToString,
                response_deserializer=google_dot_protobuf_dot_empty__pb2.Empty.FromString,
                )
...
def add_TXNServicer_to_server(servicer, server):
    rpc_method_handlers = {
            'Begin': grpc.unary_unary_rpc_method_handler(
                    servicer.Begin,
                    request_deserializer=cottontail__pb2.BeginTransaction.FromString,
                    response_serializer=cottontail__pb2.ResponseMetadata.SerializeToString,
            ),
            'Commit': grpc.unary_unary_rpc_method_handler(
                    servicer.Commit,
                    request_deserializer=cottontail__pb2.RequestMetadata.FromString,
                    response_serializer=google_dot_protobuf_dot_empty__pb2.Empty.SerializeToString,
            ),
...
class TXN(object):
    ...
    def Begin(request,
        ...
        return grpc.experimental.unary_unary(request, target, '/org.vitrivr.cottontail.grpc.TXN/Begin',
            cottontail__pb2.BeginTransaction.SerializeToString,
            cottontail__pb2.ResponseMetadata.FromString,
            options, channel_credentials,
            insecure, call_credentials, compression, wait_for_ready, timeout, metadata)
    ...
    def Commit(request,
        ...
        return grpc.experimental.unary_unary(request, target, '/org.vitrivr.cottontail.grpc.TXN/Commit',
            cottontail__pb2.RequestMetadata.SerializeToString,
            google_dot_protobuf_dot_empty__pb2.Empty.FromString,
            options, channel_credentials,
            insecure, call_credentials, compression, wait_for_ready, timeout, metadata)
